...
my (%category) = (
	...
	'mobile-apps' => ['mas', 'Appstore for Android'],
	'arts-crafts' => ['ac', 'Arts, Crafts & Sewing'],
	'automotive' => ['auto', 'Automotive'],
	'baby-products' => ['ba', 'Baby'],
	'beauty' => ['bt', 'Beauty'],
	'books' => ['b', 'Books'],
	'digital-text' => ['kstore', 'Books on Kindle'],
	'photo' => ['p', 'Camera &amp; Photo'],
	'wireless' => ['cps', 'Cell Phones & Accessories'],
	'apparel' => ['a', 'Clothing &amp; Accessories'],
	'pc' => ['pc', 'Computers'],
	'electronics' => ['e', 'Electronics'],
	'grocery' => ['gro', 'Grocery & Gourmet Food'],
	'hpc' => ['hpc', 'Health &amp; Personal Care'],
	'home-garden' => ['hg', 'Home &amp; Kitchen'],
	'hi' => ['hi', 'Home Improvement'],
	'industrial' => ['indust', 'Industrial & Scientific'],
	'jewelry' => ['jw', 'Jewelry'],
	'kitchen' => ['k', 'Kitchen & Dining'],
	'magazines' => ['mag', 'Magazine Subscriptions'],
	'digital-magazines' => ['', 'Magazines on Kindle'],
	'instant-movie' => ['', 'Movies'],
	'movies-tv' => ['mov', 'Movies & TV'],
	'music' => ['m', 'Music'],
	'musical-instruments' => ['MI', 'Musical Instruments'],
	'digital-newspapers' => ['', 'Newspapers on Kindle'],
	'office-products' => ['op', 'Office & School Supplies'],
	'garden' => ['ol', 'Patio, Lawn & Garden'],
	'pet-supplies' => ['petsupplies', 'Pet Supplies'],
	'shoes' => ['shoe', 'Shoes'],
	'software' => ['sw', 'Software'],
	'sporting-goods' => ['sg', 'Sports &amp; Outdoors'],
	'instant-tv' => ['', 'TV'],
	'toys-and-games' => ['t', 'Toys &amp; Games'],
	'videogames' => ['vg', 'Video Games'],
);
